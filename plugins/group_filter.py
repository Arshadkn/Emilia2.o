...
@Client.on_message(filters.group & filters.text & filters.incoming & filters.chat(-1001934895009) if AUTH_GROUPS else filters.text & filters.incoming & filters.group)
...
async def auto_filter(client, msg, spoll=False):
    ...
    if imdb:
        ...
        cap = f"<b>🎪 ᴛɪᴛɪʟᴇ {search}\n\n┏ 🤴 ᴀsᴋᴇᴅ ʙʏ : {message.from_user.mention}\n┣ ⚡ ᴘᴏᴡᴇʀᴇᴅ ʙʏ : [ʙʜᴀsɪ](https://t.me/+aOWzY1w5cZ44MzJl)\n┗ 🍁 ᴄʜᴀɴɴᴇʟ : [ᴄɪɴᴇᴍᴀᴄᴏᴍᴘᴀɴʏ](https://t.me/cenEma9)\n\n<i>★ ᴘᴏᴡᴇʀᴇᴅ ʙʏ  [ᴄɪɴᴇᴍᴀᴄᴏᴍᴘᴀɴʏ](https://t.me/CmRips)</i></b>"
    if imdb and imdb.get('poster'):
        try:
            ...
            logger.exception(e)
            cdb = await message.reply_photo(photo='https://te.legra.ph/file/471172796da37b50f4f4f.jpg', caption=cap, reply_markup=InlineKeyboardMarkup(btn))
            await asyncio.sleep(IMDB_DELET_TIME)
            await cdb.delete()
    else:
        crl = await message.reply_photo(photo='https://te.legra.ph/file/471172796da37b50f4f4f.jpg', caption=cap, reply_markup=InlineKeyboardMarkup(btn))
        await asyncio.sleep(IMDB_DELET_TIME)
        await crl.delete()        
    if spoll:
...
async def advantage_spell_chok(msg):
    ...
    if not movielist:
        ...
        k=await msg.reply_photo(photo="https://telegra.ph/file/4bb1968bd091453b0070c.jpg", caption=script.SPELL_CHECK_MAL, reply_markup=InlineKeyboardMarkup(btn))    
